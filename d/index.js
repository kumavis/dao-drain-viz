  ...
  function theWholeThing(){
    ...
    function createVertex(node) {
        return new Vertex()
            ...
            .annotationIcons(createAnnotations())
            .faChar(node.name[0])
        ;
    }
    ...
    function createAnnotations() {
        var retVal = [];
        if (Math.random() < 0.10) { retVal.push({ "faChar": "A", "tooltip": "Test A", "shape_colorFill": "white", "image_colorFill": "red" }); }
        if (Math.random() < 0.10) { retVal.push({ "faChar": "B", "tooltip": "Test B", "shape_colorFill": "green", "shape_colorStroke": "green", "image_colorFill": "white" }); }
        if (Math.random() < 0.10) { retVal.push({ "faChar": "C", "tooltip": "Test C", "shape_colorFill": "navy", "shape_colorStroke": "navy", "image_colorFill": "white" }); }
        return retVal;
    }
...
global.doLayout = doLayout
global.doScale = doScale
